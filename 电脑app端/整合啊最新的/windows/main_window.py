...
# 在文件顶部添加导入
from .denglu import LoginDialog  # 导入分离的登录对话框
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.is_recording = False  # 录音状态变量
        self.ui.yuyin.clicked.connect(self.toggle_recording)  # 连接录音按钮信号
    ...
    def handle_login_success(self, message):
        ...
        self.permission = message.get("permission", "student")  # 获取权限
